...
const { createDotnetVue, createDotnetAuth } = require("./lib/createDotnetVue");
...
async function create() {
  ...
  try{
    ...
    switch(projectChoice){
      case 'fullstack-vue':
        message = await createNodeFullStack(CURR_DIR, projectName)
        break;
      case 'dotnet-auth':
          message = await createDotnetAuth(CURR_DIR, projectName)
          break;
      case 'dotnet-vue':
          message = await createDotnetVue(CURR_DIR, projectName)
          break;
      default:
